      ...
      <div className="container mx-auto max-w-4xl">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Learn how the Zcash Relay works and how to verify transactions
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <Card className="p-6 bg-card border-border">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                Zcash Relay is the <strong className="text-foreground">first trustless bridge</strong> between Zcash and Starknet, 
                using on-chain Equihash proof-of-work verification implemented in Cairo.
              </p>
              <p>
                Unlike traditional bridges that require trusted signers or multisigs, our implementation 
          ...
          <Card className="p-6 bg-card border-border">
            ...
            <div className="space-y-4 text-muted-foreground">
              ...
              <ol className="space-y-3 ml-4">
                ...
                <li className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-primary/20 text-primary text-xs flex items-center justify-center flex-shrink-0 mt-0.5">2-9</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-primary/20 text-primary text-xs flex items-center justify-center flex-shrink-0 mt-0.5">10</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-primary/20 text-primary text-xs flex items-center justify-center flex-shrink-0 mt-0.5">11</span>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <code className="font-mono text-xs bg-muted px-3 py-2 rounded break-all">
                    {contractAddress}
                  </code>
